...
type
  TDM_Principal = class(TDataModule)
    ...
    RvDs_Pacientes: TRvDataSetConnection;
    SQL_RelConsultas: TSQLQuery;
    CDS_RelConsultas: TClientDataSet;
    DSP_RelConsultas: TDataSetProvider;
    RvDs_Consultas: TRvDataSetConnection;
